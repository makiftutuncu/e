...
# e-java [![](https://img.shields.io/badge/docs-2.0.0-SNAPSHOT-brightgreen.svg?style=for-the-badge&logo=java&color=007396&labelColor=333333)](https://javadoc.io/doc/dev.akif/e-java)
...
```javascript
dependencies {
  implementation('dev.akif:e-java:2.0.0-SNAPSHOT')
}
```
...
```java
libraryDependencies += "dev.akif" % "e-java" % "2.0.0-SNAPSHOT"
```
