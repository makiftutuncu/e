...
# e-gson[![](https://img.shields.io/badge/docs-2.0.0-SNAPSHOT-brightgreen.svg?style=for-the-badge&logo=java&color=007396&labelColor=333333)](https://javadoc.io/doc/dev.akif/e-gson)
...
```javascript
dependencies {
  implementation('dev.akif:e-gson:2.0.0-SNAPSHOT')
}
```
...
```scala
libraryDependencies += "dev.akif" % "e-gson" % "2.0.0-SNAPSHOT"
```
