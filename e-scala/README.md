...
# e-scala [![](https://img.shields.io/badge/docs-2.0.2-brightgreen.svg?style=for-the-badge&logo=scala&color=dc322f&labelColor=333333)](https://javadoc.io/doc/dev.akif/e-scala_2.13)
...
```scala
libraryDependencies += "dev.akif" %% "e-scala" % "2.0.2"
```
...
```javascript
dependencies {
  implementation('dev.akif:e-scala_2.13:2.0.2')
}
```
...
// unexpectedError: E = {"code":-1,"message":"Unexpected Error","time":1658217938551}

val errorWithDataAndCause = unexpectedError.data("action" -> "test").cause(notSoEmpty)
// errorWithDataAndCause: E = {"code":-1,"message":"Unexpected Error","causes":[{"code":1,"name":"error-name","message":"Error Message"}],"data":{"action":"test"},"time":1658217938551}
```
