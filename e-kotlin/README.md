...
# e-kotlin [![](https://img.shields.io/badge/docs-2.0.0-SNAPSHOT-brightgreen.svg?style=for-the-badge&logo=kotlin&color=0095d5&labelColor=333333)](https://javadoc.io/doc/dev.akif/e-kotlin)
...
```javascript
dependencies {
  implementation('dev.akif:e-kotlin:2.0.0-SNAPSHOT')
}
```
...
```kotlin
libraryDependencies += "dev.akif" % "e-kotlin" % "2.0.0-SNAPSHOT"
```
