...
libraryDependencies ++= Seq(
  "dev.akif"  % "e-core"      % "0.2.4", // Needed, core module for Java/Scala
  "dev.akif" %% "e-scala"     % "0.2.4", // Optional, for Scala
  "dev.akif" %% "e-circe"     % "0.2.4", // Optional, for Scala with circe
  "dev.akif" %% "e-play-json" % "0.2.4", // Optional, for Scala with play-json
  "dev.akif"  % "e-gson"      % "0.2.4", // Optional, for Java with gson
  "dev.akif" %% "e-zio"       % "0.2.4"  // Optional, for Scala with zio
)
```
...
```javascript
dependencies {
  implementation('dev.akif:e-core:0.2.4')           // Needed, core module for Java/Scala
  implementation('dev.akif:e-scala_2.13:0.2.4')     // Optional, for Scala
  implementation('dev.akif:e-circe_2.13:0.2.4')     // Optional, for Scala with circe
  implementation('dev.akif:e-play-json_2.13:0.2.4') // Optional, for Scala with play-json
  implementation('dev.akif:e-gson:0.2.4')           // Optional, for Java with gson
  implementation('dev.akif:e-zio_2.13:0.2.4')       // Optional, for Scala with zio
}
```
