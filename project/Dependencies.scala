...
object Dependencies {
  ...
  lazy val zio            = "dev.zio"              %% "zio"          % "1.0.2"
  ...
  lazy val mUnit           = "org.scalameta"     %% "munit"             % "0.7.14" % Test
  lazy val mUnitScalaCheck = "org.scalameta"     %% "munit-scalacheck"  % "0.7.14" % Test
  lazy val zioTest         = "dev.zio"           %% "zio-test"          % "1.0.2" % Test
  lazy val zioTestSBT      = "dev.zio"           %% "zio-test-sbt"      % "1.0.2" % Test
}
